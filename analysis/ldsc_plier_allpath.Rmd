...
We performd LD score regression for lv40(the one has lowest pvalue on testing set *pval_test_l*) and lv73(the one has the highest heritability) from [plier-nochrx-allpathway](https://xsun1229.github.io/pathway_analysis/train_model_allpath.html). 
