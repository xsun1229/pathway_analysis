...
2.  We used CanonicalPathways in PLIER R package, which contains 545 curated pathways from Reactome and KEGG. Among 480 genes, CanonicalPathways contains 255 genes.

3. We obtained 106 LVs from PLIER, 19 of them have AUC > 0.70(see figure below)
