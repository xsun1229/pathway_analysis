...
### Histogrames and Q-Q plots of heritability.
We tested 331 pathway for PCs, and 327 pathways for PEER factors.
![hist_pc_H](https://github.com/xsun1229/pathway_analysis/blob/master/output/hist_pc_H.jpeg)
...
| ÿpeer | V.G/Vpeer | SE       | zscore      | pval        | pwy                                                    |
|------|-----------|----------|-------------|-------------|--------------------------------------------------------|
